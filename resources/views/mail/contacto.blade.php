...
<center style="width: 100%; background: #444440; text-align: left;">
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600"
        ...
        <tr>
            <td bgcolor="#ffffff"
                ...
                <p style="margin: 0;">Hemos recibido su solicitud de contacto, nos comunicaremos con usted a la brevedad posible.</p>
            </td>
        </tr>
        <!--<tr>
            <td bgcolor="#ffffff"
                style="padding: 0 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
    ...
    <table role="presentation" bgcolor="green" cellspacing="0" cellpadding="0" border="0" align="center"
           width="100%">
        <tr>
